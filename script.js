...
const DiscordCounter = () => {
    ...
    const serverId = '1372408110601474148';
...
const Footer = () => (
  <footer className="w-full p-8 text-center text-gray-500 text-sm">
    ...
    <div className="flex justify-center gap-6 mt-4">
      ...
      >
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12 24a12 12 0 1 1 12-12 12.013 12.013 0 0 1-12 12Zm5.74-15.652L6.44 12.27c-.88.39-1.01.76-.23 1.1l2.58 1.12 6.09-3.79c.33-.2.62-.09.35.13l-4.93 4.45-1.15 3.39c.83 0 .81-.38 1.12-.66l1.79-1.63 3.4 2.45c.6.35 1.01.16 1.18-.52l2.1-9.84c.21-.83-.3-1.18-1.04-.84Z" />
        </svg>
      </a>
      <a
        href="https://www.youtube.com/channel/yourchannel" // Replace with your actual YouTube channel URL
        className="text-gray-400 hover:text-klar transition-colors"
        aria-label="Youtube"
        target="_blank"
        rel="noopener noreferrer"
...
const App = () => {
    ...
    useEffect(() => {
        ...
        const themes = {
            dark: {
                ...
                '--modal-card-bg': '#C09066',
                '--button-secondary-bg': '#DFA97B',
                '--button-secondary-hover-bg': '#945B28',
    ...
    const bottomTiers = pricingTiers.slice(3);
     ...
     const testimonials = [
        ...
        { name: 'Customer', stars: 4, text: "easy to work out", date: "Wed Sep 10 2025" },
            ...
            <div className="relative z-10">
                ...
                <main>
                    <section id="home" className="min-h-screen flex flex-col items-center justify-center text-center p-8 pt-20">
                        <div className="relative z-10">
                            <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold">Welcome to <span className="text-klar">CoreAPI</span></h2>
                            <p className="text-lg md:text-xl text-theme-secondary mt-4 max-w-2xl mx-auto">The pinnacle of Quality performance and reliability for Discord.</p>
                               ...
                               <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                                    <button onClick={() => handleScrollTo('pricing')} className="py-3 px-8 rounded-lg font-semibold text-center transition bg-klar hover:bg-klar-light text-white shadow-lg shadow-klar flex items-center gap-2">
                                        ...
                                        Purchase Now
                                              ...
                                              {/* New side-by-side button */}
    <button
      onClick={() => handleDiscordLogin()}
      className="py-3 px-8 rounded-lg font-semibold text-center transition bg-discord hover:bg-discord-light text-white shadow-lg shadow-discord flex items-center gap-2"
    >
      <svg
        className="w-5 h-5"
        fill="currentColor"
        viewBox="0 0 24 24"
      >
        <path d="M12 0C5.373 0 0 5.373 0 12c0 5.302 3.438 9.8 8.205 11.387.6.113.82-.26.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61-.546-1.387-1.333-1.756-1.333-1.756-1.09-.744.082-.729.082-.729 1.205.085 1.838 1.238 1.838 1.238 1.07 1.834 2.807 1.304 3.492.997.108-.775.418-1.305.76-1.605-2.665-.303-5.466-1.332-5.466-5.933 0-1.31.468-2.382 1.236-3.222-.124-.303-.536-1.523.117-3.176 0 0 1.008-.322 3.3 1.23a11.5 11.5 0 013.003-.404c1.018.005 2.043.138 3.003.404 2.29-1.552 3.296-1.23 3.296-1.23.655 1.653.243 2.873.12 3.176.77.84 1.234 1.912 1.234 3.222 0 4.61-2.804 5.625-5.475 5.922.43.372.823 1.103.823 2.222 0 1.604-.015 2.896-.015 3.287 0 .32.216.694.825.576C20.565 21.796 24 17.298 24 12c0-6.627-5.373-12-12-12z"/>
      </svg>
      Connect Discord
    </button>
                                </div>
