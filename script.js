...
const AIHelperModal = ({ onClose }) => {
    ...
    const [chatHistory, setChatHistory] = useState([{ role: 'ai', text: 'Hello! I am the LyteSupplies AI assistant. How can I help you today? Feel free to ask about features, pricing, or anything else.' }]);
    ...
    const quickQuestions = ["What are the features for FF2?", "How much is lifetime access?", "Is LyteSupplies safe to use?"];
    return (
        <Modal onClose={onClose}>
            {(handleClose) => (
